...
(async() => {
    try {
        ...
        let usergroup2 = await db_usergroup.create({
            domain_id: domain.domain_id,
            usergroup_name: 'test',
        ...
        let testUser = await db_user.create({
            user_id: await Sequence.genUserID(),
            domain_id: domain.domain_id,
            usergroup_id: usergroup.usergroup_id,
        ...
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '预约管理',
            menu_path: '/crm/appointmentControl',
            menu_icon: '',
            domain_flag: GLBConfig.TRUE,
            menu_index: 2
        });
        ...
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '订单详情',
            menu_path: '/crm/orderDtailControl',
            menu_icon: '',
            show_flag: GLBConfig.FALSE,
            domain_flag: GLBConfig.TRUE,
            menu_index: 4
        });
        menu = await db_menu.create({
        ...
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '首页',
            menu_path: '/hq/homePageHQControl',
            menu_icon: '',
            domain_flag: GLBConfig.TRUE,
            menu_index: 1
        });
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '客户管理',
            menu_path: '/hq/customerHQControl',
            menu_icon: '',
            domain_flag: GLBConfig.TRUE,
            menu_index: 2
        });
        ...
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '物料模板维护',
            menu_path: '/op/materielTemplateControl',
            menu_icon: '',
            domain_flag: GLBConfig.TRUE,
            menu_index: 2
        });
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '施工模板维护',
            menu_path: '/op/constructionTemplateControl',
            menu_icon: '',
            domain_flag: GLBConfig.TRUE,
            menu_index: 3
        });
        ...
        menu = await db_menu.create({
            ...
            auth_flag: '1',
            menu_name: '采购管理',
            menu_path: '/srm/purchaseHQControl',
            menu_icon: '',
            domain_flag: GLBConfig.TRUE,
            menu_index: 1
        });
